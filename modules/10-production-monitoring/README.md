# Module 10: Production Monitoring System
...
- Understand the core concepts of Production Monitoring System
...
Production Monitoring System is a fundamental component of Model Monitoring and Drift Detection: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Production Monitoring System like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/10-production-monitoring/
```
...
```bash
ls modules/10-production-monitoring/lab/starter/
```
...
cd modules/10-production-monitoring/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/10-production-monitoring/validation/validate.sh
```
...
1. What is the main purpose of Production Monitoring System?
