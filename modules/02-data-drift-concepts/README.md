# Module 02: Data Drift Concepts and Types
...
- Understand the core concepts of Data Drift Concepts and Types
...
### What is Data Drift Concepts and Types?

Data Drift Concepts and Types is a fundamental component of Model Monitoring and Drift Detection: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Data Drift Concepts and Types like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/02-data-drift-concepts/
```
...
```bash
ls modules/02-data-drift-concepts/lab/starter/
```
...
cd modules/02-data-drift-concepts/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/02-data-drift-concepts/validation/validate.sh
```
...
1. What is the main purpose of Data Drift Concepts and Types?
...
**Next: [Module 03 →](../03-evidently-ai-setup/)**
