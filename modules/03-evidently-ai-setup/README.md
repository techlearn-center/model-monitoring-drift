# Module 03: Evidently AI Setup and Dashboards
...
- Understand the core concepts of Evidently AI Setup and Dashboards
...
### What is Evidently AI Setup and Dashboards?

Evidently AI Setup and Dashboards is a fundamental component of Model Monitoring and Drift Detection: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Evidently AI Setup and Dashboards like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/03-evidently-ai-setup/
```
...
```bash
ls modules/03-evidently-ai-setup/lab/starter/
```
...
cd modules/03-evidently-ai-setup/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/03-evidently-ai-setup/validation/validate.sh
```
...
1. What is the main purpose of Evidently AI Setup and Dashboards?
...
**Next: [Module 04 →](../04-statistical-tests/)**
