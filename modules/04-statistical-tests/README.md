# Module 04: Statistical Tests for Drift
...
- Understand the core concepts of Statistical Tests for Drift
...
### What is Statistical Tests for Drift?

Statistical Tests for Drift is a fundamental component of Model Monitoring and Drift Detection: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Statistical Tests for Drift like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/04-statistical-tests/
```
...
```bash
ls modules/04-statistical-tests/lab/starter/
```
...
cd modules/04-statistical-tests/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/04-statistical-tests/validation/validate.sh
```
...
1. What is the main purpose of Statistical Tests for Drift?
...
**Next: [Module 05 →](../05-model-performance-tracking/)**
